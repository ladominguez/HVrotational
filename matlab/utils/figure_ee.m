function [h, leyenda] = figure_ee(ee, f, HV, leyenda, estacion)
    ...
    for ic = 1:N
        ...
        HV_plot = multiplicar_funcion_transferencia(HV.HVmean_comb{ic},HV.fcomb{ic});
        % sin considerar funcion de transferencia - semilogx(HV.fcomb{ic},HV.HVmean_comb{ic},'linewidth',1.5); 
        semilogx(HV.fcomb{ic},HV_plot,'linewidth',1.5)
        hold on
        grid on
